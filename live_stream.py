...
# httppicamera.readthedocs.ioenlatestrecipes2.html#web-streaming
...
html
head
titleRaspberry Pi - Surveillance Cameratitle
head
body
centerh1Raspberry Pi - Surveillance Camerah1center
centerimg src=stream.mjpg width=640 height=480center
body
html
